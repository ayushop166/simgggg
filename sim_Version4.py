...
# ==========================
# BOT TOKEN HARDCODED BELOW!
# ==========================
BOT_TOKEN: ClassVar[str] = "8311115232:AAG9OVLlKB2WhDjMnnOMpXCyq2tq4ZWVZq4"
...
def start_command_handler(message: ClassVar[Any]) -> NoReturn:
    ...
    Shows welcome messages and all commands to users
    ...
    # Send welcome + command list message
    ...
    bot.reply_to(
        ...
        text=(
            ...
            "\nJust send any command to use the bot!"
        )
    )
